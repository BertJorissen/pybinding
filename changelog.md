...
* changed locations for `pb.results` and `pb.pltutils`
* Pre-compiled versions for all platforms
* dropped support for python <3.8

Major release, releases after v0.9.5 up to this release (v1.0.4) are unstable and should *not* be used.

Major addition is the inclusion of the `pb.Wavefunction` to calculate properties that are related to the wavefunction,
such as the berry phase, orbital contribution, bands disentanglement, operators and projections on different bases.
